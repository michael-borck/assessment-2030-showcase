...
This toolkit is a companion to the **AI in Pedagogical Design and Delivery** workshop. It extends **Activity 3 – 5‑Step Critique Framework** with business‑focused questions and a few practical templates you can reuse in units, workplace activities, or assessments.

You can read this on its own, or alongside **Activity 3 – 5‑Step Critique Framework**.
...
This toolkit aligns with the workshop’s 5‑step model (Purpose, Plausibility, Evidence, Stakes, Action). Here is a more business‑specific lens you can use with any AI‑generated recommendation, policy, plan, or analysis.
...
You can map these directly to the workshop model:
...
This mirrors what we practise in **Activity 3 – 5‑Step Critique Framework**, but with more business detail and a focus on professional judgement you can carry into your career.